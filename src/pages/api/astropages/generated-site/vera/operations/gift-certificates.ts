...
import { issueVeraGiftCertificate } from "../../../../../../server/vera/operations.ts";
...
const feature = "vera.operations.gift-certificates";
...
export const POST: APIRoute = async (context) => {
  ...
  return veraResultResponse(feature, await issueVeraGiftCertificate(auth.env as VeraEnv, parsed.body));
};
