...
import { createVeraNewsletterCampaign } from "../../../../../../server/vera/operations.ts";
...
const feature = "vera.operations.newsletter-campaigns";
...
export const POST: APIRoute = async (context) => {
  ...
  return veraResultResponse(feature, await createVeraNewsletterCampaign({
    env: auth.env as VeraEnv,
    input: parsed.body,
    actor: String(auth.claims.sub || "control-plane"),
  }));
};
