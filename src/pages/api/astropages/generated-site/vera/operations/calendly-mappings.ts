...
import { replaceVeraCalendlyMappings } from "../../../../../../server/vera/operations.ts";
...
const feature = "vera.operations.calendly-mappings";
...
export const PUT: APIRoute = async (context) => {
  ...
  return veraResultResponse(feature, await replaceVeraCalendlyMappings(auth.env as VeraEnv, parsed.body));
};
