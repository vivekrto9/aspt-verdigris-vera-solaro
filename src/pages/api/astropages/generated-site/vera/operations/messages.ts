...
import { sendVeraStaffMessage } from "../../../../../../server/vera/operations.ts";
...
const feature = "vera.operations.messages";
...
export const POST: APIRoute = async (context) => {
  ...
  return veraResultResponse(feature, await sendVeraStaffMessage(auth.env as VeraEnv, parsed.body));
};
