// Provider webhooks sit outside the vertical namespace, matching the base
// template's /generated-site/webhooks/payment/stripe path. The vera/ route stays
// live so already-registered endpoints keep working until Stripe is repointed.
